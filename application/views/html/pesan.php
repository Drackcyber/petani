					...
					<article class="blog-article">
						...
						<div class="blog-content">
							<div class="blog-content-title">
								<h2><a href="#" class="invarseColor">Info Cara Pemesanan</a></h2>
							</div>
							<div class="clearfix">
							...
							<div class="blog-content-entry">
								<p>
									Berikut ini adalah list bagaimana cara melakukan pemesanan item (barang) di petani.com
								</p>

								<blockquote>
									<li>Silahkan terlebih dahulu login sebagai konsumen, bila belum terdaftar lakukan registrasi melalui link Registrasi Konsumen. Setelah registrasi, silahkan login pada panel sebelah kiri yang telah disediakan.</li>
									<li>Pilih link menu Pemesanan, kemudian silahkan pilih produk bibit/pupuk/mesin dan masukkan jumlah yang ingin anda pesan. <b>Untuk jumlah barang yang dapat dipesan minimal 1 produk dan maksimal 20 produk</b></li>
			                    	<li>Setelah anda memilih produk yang akan dipesan sesuai dengan keinginan anda, lanjutkan proses pemesanan dengan menekan tombol Proses Pemesanan </li>
									<li>Isi data - data penerima dari pemesanan anda, jika data penerima sama dengan data yang melakukan pemesanan silahkan centang check box isian penerima pemesanan.</li>
									<li>Proses pemesanan anda telah diproses.</li>
								</blockquote>

								<p>
									<strong>Catatan : </strong> <br>
									<font color="#FF0000">Semua harga produk yang ada di petanionline ini sudah termasuk dengan biaya pengiriman atau konsumen telah di bebaskan dari biaya kirim.</font>
								</p>
							</div>
